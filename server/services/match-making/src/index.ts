...
import { SocketController } from './presentation/socket.controller';
import { HandleDisconnectUseCase } from './application/use-cases/handle-disconnect.uc';
import { JoinMatchUseCase } from './application/use-cases/join-match.uc';
import { MatchMakingRepo } from './infrastructure/repositories/match-making';
import { InMemoryPlayerRepository } from './infrastructure/repositories/in-memory-player';
import { CommunicationService } from './infrastructure/services/communication.service';
